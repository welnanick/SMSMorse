...
public class Preferences extends PreferenceActivity {
    ...
    private OnPreferenceChangeListener mVibratePartListener = new OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            preference.setSummary(getString(R.string.preference_vibrate_parts_summary) + " " +
                    getResources().getStringArray(R.array.preference_vibrate_parts_entries)[Integer
    ...
    private void loadPreferences() {
        ...
        mCheckBoxEnabled =
                (CheckBoxPreference) screen.findPreference(getString(R.string.preference_enabled));
        ...
        mDotLength = (BetterSeekBarPreference) screen
        ...
        final DialogPreference about =
                (DialogPreference) screen.findPreference(getString(R.string.preference_about));
        about.setDialogLayoutResource(R.layout.about);

        String version = null;
        try {

            version = getPackageManager().getPackageInfo("com.jakewharton.smsmorse",
